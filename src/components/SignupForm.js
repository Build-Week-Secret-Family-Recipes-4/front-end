...
export default function SignupForm() {
  ...
  const formSubmit = (e) => {
    ...
    axios
      .post(
        "https://secret-recipe-cookbook.herokuapp.com/auth/register",
        formState
      )
      .then((response) => {
        ...
        <Fields>
          <label htmlFor="firstname">
            ...
            {errorState.firstname.length > 0 ? (
              <Error className="error">{errorState.firstname}</Error>
            ) : null}
          </label>
        </Fields>
        <Fields>
          <label htmlFor="lastname">
            ...
            {errorState.lastname.length > 0 ? (
              <Error className="error">{errorState.lastname}</Error>
            ) : null}
          </label>
        </Fields>
        <Fields>
          <label htmlFor="email">
            ...
            {errorState.email.length > 0 ? (
              <Error className="error">{errorState.email}</Error>
            ) : null}
          </label>
        </Fields>
        <Fields>
